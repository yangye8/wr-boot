...
typedef Elf32_Addr        Elf32_Word;
typedef signed int        Elf32_Sword;

typedef unsigned long long  Elf64_Addr;
typedef Elf64_Addr          Elf64_Off;
typedef Elf32_Half          Elf64_Half;
typedef Elf32_Addr          Elf64_Word;
typedef Elf32_Sword         Elf64_Sword;
typedef Elf64_Addr          Elf64_Xword;
...
typedef struct
{
  Elf64_Sxword m_value;      /* Symbol value.  */
...
extern void describe_elf_hdr(Elf32_Ehdr* ehdr);
extern void describe_elf_interpreter(Elf32_Ehdr* ehdr);
extern void list_needed_libraries(Elf32_Dyn* dynamic, char *strtab);
extern Elf32_Shdr * elf_find_section_type( uint32_t key, Elf32_Ehdr *ehdr);
extern void * elf_find_dynamic( long long key, Elf32_Dyn *dynp,Elf32_Ehdr *ehdr, int return_val);

#ifdef __cplusplus
}
#endif

#ifdef _WRS_CONFIG_ARCH_PENTIUM
#include <elfI86.h>
#elif defined (_WRS_CONFIG_ARCH_ARM)
#include <elfArm.h>
#elif defined (_WRS_CONFIG_ARCH_PPC)
#include <elfPpc.h>
#endif
